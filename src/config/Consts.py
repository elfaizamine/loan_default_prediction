...
PREVIOUS_LOANS_INSTALMENT_PAYMENTS_FILE_NAME = "installments_payments.csv"
...
CLEAN_PREVIOUS_LOANS_PAYMENTS_FILE_NAME = "clean_past_loans_payments.csv"
...
label_enc_loan_app_col = ['WEEKDAY_APPR_PROCESS_START', 'NAME_EDUCATION_TYPE', 'NAME_CONTRACT_TYPE']
...
label_enc_loan_app_cat = [['MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY'],
                          ['Lower secondary', 'Secondary / secondary special', 'Incomplete higher', 'Higher education',
                           'Academic degree'], ['Consumer loans', 'Cash loans', 'Revolving loans']]

binary_enc_loan_app = ['CODE_GENDER', 'FLAG_OWN_CAR', 'FLAG_OWN_REALTY']
...
FS_PARAMETERS = {'OPTIMISATION': {'POPULATION_SIZE': 20, 'P_CROSSOVER': 0.8, 'P_MUTATION': 0.2, 'MAX_GENERATIONS': 10,
                                  'HALL_OF_FAME_SIZE': 4, 'FEATURE_PENALTY_FACTOR': 0.001, 'RANDOM_SEED': 13,
                                  'TOURNAMENT_SIZE': 3, 'MUTATION_FLIP': 1},
                 'MODEL': {'max_depth': 15, 'n_estimators': 100, 'n_jobs': 20, 'verbose': False},
                 'CROSS_VALIDATION_FOLDS': 3}

PATH_SAVE_BEST_FEATURES = 'src/config/selectedFeatures.json'
